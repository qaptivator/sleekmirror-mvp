<template>
    <div class="flex-1 relative bg-obsidian overflow-hidden">
      ...
      >
        <div class="rounded-2xl border border-dashed border-gold/30 w-64 h-64 relative overflow-hidden">
          <div
            v-for="i in 3" :key="i"
      ...
      <Transition name="fade">
        ...
        >
          <div class="space-y-4 text-center">
            ...
            <p class="text-gold-soft font-medium text-sm tracking-wide transition-all duration-300">
              {{ scanningMessage }}
            </p>
          </div>
        </div>
